...
1. Install a Ruby interpreter compatible with MRI 2.x, RubyGems, Ruby on Rails 4.1.x, and Rake.
...
Copyright (c) 2015 Open Source Bridge, Igal Koshevoy, Kirsten Comandich
